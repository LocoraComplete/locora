...
export default function Comments() {
    ...
    <View style={styles.commentRow}>
      ...
      <View style={{ flex: 1 }}>
        <View style={styles.topLine}>
          ...
          <Text
            style={[styles.time, { color: themeColors.secondaryText }]}
          >
  ...
  return (
    <SafeAreaView
      ...
      edges={['top', 'left', 'right']} // Keeps bottom edge for the inputRow
    >
      <KeyboardAvoidingView
        style={{ flex: 1 }}
        ...
        <View
          style={[
            styles.inputRow,
            {
              ...
              paddingBottom: Platform.OS === 'ios' ? 20 : 12 // Manual padding for home indicator
            },
          ]}
        >
          <TextInput
          ...
          <TouchableOpacity onPress={sendComment}>
            <Text style={[styles.post, { color: "#007AFF" }]}>
              Post
            </Text>
          </TouchableOpacity>
        </View>
