...
useFocusEffect(
  ...
  if (loading)
    return <SafeAreaView style={{ flex: 1, backgroundColor: themeColors.background }} />;
...
const styles = StyleSheet.create({
  ...
  plusIcon: { position: "absolute", bottom: 0, right: 0, width: 26, height: 26, borderRadius: 13, justifyContent: "center", alignItems: "center" },
  statsRow: { flex: 1, flexDirection: "row", justifyContent: "space-around" },
  statItem: { alignItems: "center" },
  statNumber: { fontWeight: "900", fontSize: 16 },
  statLabel: { fontSize: 12 },
  bioBox: { marginTop: 10 },
  name: { fontWeight: "900", fontSize: 15 },
  bio: { marginTop: 4 },
  buttonRow: { flexDirection: "row", justifyContent: "space-between", marginTop: 15 },
  outlineButton: { flex: 1, borderWidth: 1, paddingVertical: 8, borderRadius: 8, alignItems: "center", marginHorizontal: 4 },
